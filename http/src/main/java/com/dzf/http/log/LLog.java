...
import com.dzf.http.log.s.BaseLog;
import com.dzf.http.log.s.FileLog;
import com.dzf.http.log.s.JsonLog;
import com.dzf.http.log.s.XmlLog;
...
public final class LLog {
    ...
    private static final String TAG_DEFAULT = "LLog";
